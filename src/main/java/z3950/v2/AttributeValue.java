...
//================================================================
/**
 * Class for representing a <code>AttributeValue</code> from <code>IR</code>
 *
 * <pre>
 * AttributeValue ::=
  ...
  if (check_tag) {
    if (ber.tag_get() != 121 ||
      ...
      throw new ASN1EncodingException
        ("Zebulun: AttributeValue: bad BER: tag=" + ber.tag_get() + " expected 121\n");
  }
...
ber_encode()
       throws ASN1Exception
{
  return ber_encode(BEREncoding.CONTEXT_SPECIFIC_TAG, 121);
}
