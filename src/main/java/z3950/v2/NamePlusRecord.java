...
//================================================================
/**
 * Class for representing a <code>NamePlusRecord</code> from <code>IR</code>
 *
 * <pre>
 * NamePlusRecord ::=
 * SEQUENCE {
 *   [0] IMPLICIT DatabaseName OPTIONAL
 *   [1] EXPLICIT NamePlusRecord1
 * }
 * </pre>
 *
       ...
       throws ASN1Exception
{
  ...
  // Decoding: [0] IMPLICIT DatabaseName OPTIONAL
  ...
  if (p.tag_get() == 0 &&
    ...
    s_1 = new DatabaseName(p, false);
    part++;
  }

  // Decoding: [1] EXPLICIT NamePlusRecord1
  ...
  if (p.tag_get() != 1 ||
      p.tag_type_get() != BEREncoding.CONTEXT_SPECIFIC_TAG)
    throw new ASN1EncodingException
      ("Zebulun NamePlusRecord: bad tag in s_2\n");

  try {
    tagged = (BERConstructed) p;
  } catch (ClassCastException e) {
    throw new ASN1EncodingException
      ("Zebulun NamePlusRecord: bad BER encoding: s_2 tag bad\n");
  }
  ...
  s_2 = new NamePlusRecord1(tagged.elementAt(0), true);
  part++;
       ...
       throws ASN1Exception
{
  ...
  // Encoding s_1: DatabaseName OPTIONAL

  if (s_1 != null) {
    fields[x++] = s_1.ber_encode(BEREncoding.CONTEXT_SPECIFIC_TAG, 0);
  }

  // Encoding s_2: NamePlusRecord1 

  enc = new BEREncoding[1];
  enc[0] = s_2.ber_encode();
...
public DatabaseName s_1; // optional
public NamePlusRecord1 s_2;
