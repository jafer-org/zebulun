...
//================================================================
/**
 * Class for representing a <code>InitializeRequest</code> from <code>IR</code>
 *
 * <pre>
 * InitializeRequest ::=
 * SEQUENCE {
 ...
 *   idAuthentication [7] EXPLICIT ANY OPTIONAL
...
public
InitializeRequest(BEREncoding ber, boolean check_tag)
       ...
       throws ASN1Exception
{
  ...
  // Decoding: idAuthentication [7] EXPLICIT ANY OPTIONAL
  ...
  if (p.tag_get() == 7 &&
    ...
    s_idAuthentication = new ASN1Any(tagged.elementAt(0), true);
    part++;
  }
       ...
       throws ASN1Exception
{
  ...
  // Encoding s_idAuthentication: ANY OPTIONAL
...
public ASN1Any s_idAuthentication; // optional
