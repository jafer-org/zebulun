...
//================================================================
/**
 * Class for representing a <code>DeleteResultSetRequest</code> from <code>IR</code>
 *
 * <pre>
...
public
DeleteResultSetRequest(BEREncoding ber, boolean check_tag)
       ...
       throws ASN1Exception
{
  ...
  // Decoding: deleteOperation [32] IMPLICIT INTEGER
  ...
  if (p.tag_get() != 32 ||
    ...
    throw new ASN1EncodingException
      ("Zebulun DeleteResultSetRequest: bad tag in s_deleteOperation\n");

  s_deleteOperation = new ASN1Integer(p, false);
  part++;
       ...
       throws ASN1Exception
{
  ...
  // Encoding s_deleteOperation: INTEGER 

  fields[x++] = s_deleteOperation.ber_encode(BEREncoding.CONTEXT_SPECIFIC_TAG, 32);
...
toString()
{
  ...
  if (0 < outputted)
    str.append(", ");
  str.append("deleteOperation ");
  str.append(s_deleteOperation);
  outputted++;
...
public ASN1Integer s_deleteOperation;
...
// Enumerated constants for deleteOperation
