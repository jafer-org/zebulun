 ...
 *   processingType [4] EXPLICIT InternationalString
 *   processingOptions [5] EXPLICIT InternationalString OPTIONAL
 *   sceneSelectionOptions [6] EXPLICIT InternationalString OPTIONAL
 *   otherInfo [7] EXPLICIT OtherInformation OPTIONAL
 * }
 * </pre>
 *
       ...
       throws ASN1Exception
{
  ...
  // Decoding: processingType [4] EXPLICIT InternationalString
  ...
  if (p.tag_get() != 4 ||
      p.tag_type_get() != BEREncoding.CONTEXT_SPECIFIC_TAG)
    throw new ASN1EncodingException
      ("Zebulun OrderItem: bad tag in s_processingType\n");

  try {
    tagged = (BERConstructed) p;
  } catch (ClassCastException e) {
    throw new ASN1EncodingException
      ("Zebulun OrderItem: bad BER encoding: s_processingType tag bad\n");
  }
  if (tagged.number_components() != 1) {
    throw new ASN1EncodingException
      ("Zebulun OrderItem: bad BER encoding: s_processingType tag bad\n");
  ...
  s_processingType = new InternationalString(tagged.elementAt(0), true);
  part++;
  ...
  // Decoding: processingOptions [5] EXPLICIT InternationalString OPTIONAL
  ...
  if (p.tag_get() == 5 &&
    ...
    s_processingOptions = new InternationalString(tagged.elementAt(0), true);
    part++;
  }

  // Decoding: sceneSelectionOptions [6] EXPLICIT InternationalString OPTIONAL
  ...
  if (p.tag_get() == 6 &&
    ...
    s_sceneSelectionOptions = new InternationalString(tagged.elementAt(0), true);
    part++;
  }

  // Decoding: otherInfo [7] EXPLICIT OtherInformation OPTIONAL
       ...
       throws ASN1Exception
{
  ...
  // Encoding s_processingType: InternationalString 

  enc = new BEREncoding[1];
  enc[0] = s_processingType.ber_encode();
  fields[x++] = new BERConstructed(BEREncoding.CONTEXT_SPECIFIC_TAG, 4, enc);

  // Encoding s_processingOptions: InternationalString OPTIONAL
  ...
  // Encoding s_sceneSelectionOptions: InternationalString OPTIONAL
...
toString()
{
  ...
  if (0 < outputted)
    str.append(", ");
  str.append("processingType ");
  str.append(s_processingType);
  outputted++;
...
public InternationalString s_processingType;
public InternationalString s_processingOptions; // optional
public InternationalString s_sceneSelectionOptions; // optional
