 ...
 * ASN1Decoder
 *
 * This is an ASN1 decoder which can handle all the standard ASN.1 types (those
 * with UNIVERSAL tag types). It is used for decoding generic BER encodings into
 * ASN.1 objects.
 *
