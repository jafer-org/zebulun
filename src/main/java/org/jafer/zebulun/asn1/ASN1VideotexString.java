/*
 * $Id: ASN1VideotexString.java,v 1.5 1999/04/13 07:23:08 hoylen Exp $
 *
 ...
 *
 * The <code>VideotexString</code> type denotes an arbitrary string of Videotex
...
public class ASN1VideotexString extends ASN1OctetString {
  ...
  public ASN1VideotexString(BEREncoding ber, boolean check_tag)
    ...
    if (check_tag) {
      if (ber.tag_get() != TAG
        ...
        throw new ASN1EncodingException("ASN.1 VideotexString: bad BER: tag=" + ber.tag_get()
                + " expected " + TAG + "\n");
      }
    }
  }
  ...
  public static class XER_Parser_Proxy
    ...
    public void endElement(XERsaxHandler handler,
      ...
      handler.member_got(new ASN1VideotexString(proxy_value));
    }
