 ...
 *
 * The <code>T61String</code> type denotes an arbitrary string of T.61
 * characters, or TeletextString. T.61 is an eight-bit extension to the ASCII
 * character set. Special escape sequences specify the interpretation of
 * subsequent character values (e.g. as Japanese rather than Latin). A T61String
 * value can be of any length, including zero. This type is a string type.
 *
...
public final class ASN1T61String extends ASN1OctetString {
  ...
  //----------------------------------------------------------------
  /**
   * Constructor for an T61String object. It sets the tag to the default value
   * of UNIVERSAL 20 (0x14).
   *
  ...
  public ASN1T61String(BEREncoding ber, boolean check_tag)
    ...
    if (check_tag) {
      if (ber.tag_get() != TAG
        ...
        throw new ASN1EncodingException("ASN.1 T61String: bad BER: tag=" + ber.tag_get()
                + " expected " + TAG + "\n");
      }
    }
  }
