...
//----------------------------------------------------------------
/**
 * This class is an event handler for SAX. This allows XER encodings
 * to be parsed using any SAX compliant XML parser.
 * <p>
 ...
 * </pre>
 *
 * Refer to the SAX XML parser documentation for more details on how
 * to use SAX parsers.
 */
...
public class XERsaxHandler extends HandlerBase {
   ...
   *
   * Indicates that the XER parser should now begin to parse for the
   * given type.  Call this before parsing begins.
   *
   ...
   *
   * You should not need to call this method at all.
   * This is used internally to indicate that the parsing for a
   * production was successful and to return the generated object
   * to the previous parsing level.
   *
   ...
   * SAX callback method.
   *
   * Called by the SAX parser, it then redirect the event to the
   ...
   * SAX callback method.
   *
   * Called by the SAX parser when a locator is available. This is
   * saved for use when generating exceptions.
   *
  ...
  /**
   * Internal exception generator for an unexpected begin XML tag.
  ...
  /**
   * Internal exception generator for an unexpected end XML tag.
   * This method will always throw an exception.
   *
   * @param xer_tag  the XML tag being parsed for.
   * @param name     the XML tag that was found.
  ...
  /**
   * Internal exception generator for unexpected character data.
   * This method will always throw an exception.
   *
   * @param xer_tag  the XML tag being parsed for.
   * @exception org.xml.sax.SAXException  the exception thrown.
  ...
  /**
   * Internal exception generator for an unexpected member.
   * This method will always throw an exception.
   *
   * @param xer_tag  the XML tag being parsed for.
   * @exception org.xml.sax.SAXException  the exception thrown.
  ...
  //----------------------------------------------------------------
  /**
   * Internal error message generator. Constructs a string with
   * file and line number details (when available) and the currently
  ...
  //================================================================
  /**
   * A reference to the locator provided by the SAX parser, or null
   * if there is none.
   */
  ...
  /**
   * Stack of XER parsing proxy objects.  The top element being the
   * one currently being parsed for.
   */
  ...
  /**
   * Holder of the top level parse result when it is successfully
   * parsed. This is then returned to the user when the get() function
   * is called.  Null if no result.
   */
