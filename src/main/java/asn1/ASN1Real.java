 ...
 * java.lang.Double.NEGATIVE_INFINITY and java.lang.Double.POSITIVE_INFINITY.
 * It cannot be NaN.
 * <p>
 * <em>
...
public final static int TAG = 0x09;
   ...
   * to change its representation at a later date
...
private double value;
  ...
  //================================================================
  /**
   * Constructor for an ASN.1 REAL object. The tag is
   * set to the default tag of UNIVERSAL 9.
...
ASN1Real()
  ...
  /**
   * Constructor for an ASN.1 REAL object. The tag is
   * set to the default tag of UNIVERSAL 9, and the value to the
   * given number.
   *
...
public
ASN1Real(BEREncoding ber, boolean check_tag)
...
ber_decode(BEREncoding ber_enc, boolean check_tag)
       throws ASN1EncodingException
  {
	...
	throw new ASN1EncodingException
	  ("ASN.1 REAL: bad BER: tag=" + ber_enc.tag_get() + 
	   " expected " + TAG + "\n");
      }
    }
   ...
   * @exception	ASN1Exception when the REAL is invalid
...
ber_encode()
  ...
  //----------------------------------------------------------------
  /**
   * Returns a BER encoding of the REAL. Explicitly tagged with
   * the supplied tag.
   *
   * @return	The BER encoding of the REAL
   * @exception	ASN1Exception when the REAL is invalid
