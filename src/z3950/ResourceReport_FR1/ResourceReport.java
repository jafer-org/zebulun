...
//================================================================
/**
 * Class for representing a <code>ResourceReport</code> from <code>ResourceReport-Format-Resource-1</code>
 *
 * <pre>
 * ResourceReport ::=
 * SEQUENCE {
       ...
       throws ASN1Exception
{
  ...
  // Decoding: estimates [1] IMPLICIT SEQUENCE OF Estimate

  if (num_parts <= part) {
    // End of record, but still more elements to get
    throw new ASN1Exception("Zebulun ResourceReport: incomplete");
  }
  ...
  if (p.tag_get() != 1 ||
    ...
    throw new ASN1EncodingException
      ("Zebulun ResourceReport: bad tag in s_estimates\n");
  ...
  // Decoding: message [2] IMPLICIT InternationalString
  ...
  if (p.tag_get() != 2 ||
      p.tag_type_get() != BEREncoding.CONTEXT_SPECIFIC_TAG)
    throw new ASN1EncodingException
      ("Zebulun ResourceReport: bad tag in s_message\n");
       ...
       throws ASN1Exception
{
  ...
  // Encoding s_estimates: SEQUENCE OF 
  ...
  // Encoding s_message: InternationalString 
