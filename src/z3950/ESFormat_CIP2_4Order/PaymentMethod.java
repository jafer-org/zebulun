...
//================================================================
/**
 * Class for representing a <code>PaymentMethod</code> from <code>CIP-Order-ES</code>
 *
 * <pre>
 * PaymentMethod ::=
 * CHOICE {
...
public final class PaymentMethod extends ASN1Any
{
...
//----------------------------------------------------------------
/**
 * Default constructor for a PaymentMethod.
 */
...
//----------------------------------------------------------------
/**
 * Constructor for a PaymentMethod from a BER encoding.
 * <p>
 *
...
public
PaymentMethod(BEREncoding ber, boolean check_tag)
       ...
       throws ASN1Exception
{
  ...
  throw new ASN1Exception("Zebulun PaymentMethod: bad BER encoding: choice not matched");
}

//----------------------------------------------------------------
/**
 * Returns a BER encoding of PaymentMethod.
 *
       ...
       throws ASN1Exception
{
  ...
  if (c_privateKnown != null) {
    if (chosen != null)
      throw new ASN1Exception("CHOICE multiply set");
    chosen = c_privateKnown.ber_encode(BEREncoding.CONTEXT_SPECIFIC_TAG, 3);
  }
  ...
  if (c_privateNotKnown != null) {
    if (chosen != null)
      throw new ASN1Exception("CHOICE multiply set");
    chosen = c_privateNotKnown.ber_encode(BEREncoding.CONTEXT_SPECIFIC_TAG, 4);
  }
       ...
       throws ASN1Exception
{
  ...
  throw new ASN1EncodingException("Zebulun PaymentMethod: cannot implicitly tag");
}
