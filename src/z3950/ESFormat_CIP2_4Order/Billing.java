       ...
       throws ASN1Exception
{
  ...
  // Decoding: customerReference [2] IMPLICIT CustomerReference
  ...
  if (p.tag_get() != 2 ||
      p.tag_type_get() != BEREncoding.CONTEXT_SPECIFIC_TAG)
    throw new ASN1EncodingException
      ("Zebulun Billing: bad tag in s_customerReference\n");

  s_customerReference = new CustomerReference(p, false);
  part++;
       ...
       throws ASN1Exception
{
  ...
  // Encoding s_customerReference: CustomerReference
...
public CustomerReference s_customerReference;
