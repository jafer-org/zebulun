...
//================================================================
/**
 * Class for representing a <code>ListStatuses1</code> from <code>IR</code>
 *
 * <pre>
 * ListStatuses1 ::=
 * SEQUENCE {
       ...
       throws ASN1Exception
{
  ...
  s_1 = new ResultSetId(p, true);
  part++;

  // Decoding: DeleteSetStatus
  ...
  s_2 = new DeleteSetStatus(p, true);
  part++;
       ...
       throws ASN1Exception
{
  ...
  // Encoding s_1: ResultSetId 

  fields[x++] = s_1.ber_encode();

  // Encoding s_2: DeleteSetStatus 
...
public ResultSetId s_1;
public DeleteSetStatus s_2;
