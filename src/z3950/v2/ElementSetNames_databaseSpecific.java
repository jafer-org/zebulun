...
//================================================================
/**
 * Class for representing a <code>ElementSetNames_databaseSpecific</code> from <code>IR</code>
 *
 * <pre>
       ...
       throws ASN1Exception
{
  ...
  s_1 = new DatabaseName(p, true);
  part++;

  // Decoding: ElementSetName
       ...
       throws ASN1Exception
{
  ...
  // Encoding s_1: DatabaseName 

  fields[x++] = s_1.ber_encode();

  // Encoding s_2: ElementSetName 
...
public DatabaseName s_1;
public ElementSetName s_2;
