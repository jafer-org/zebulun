...
//================================================================
/**
 * Class for representing a <code>AttributeType</code> from <code>IR</code>
 *
 * <pre>
 * AttributeType ::=
 * [120] IMPLICIT INTEGER
 * </pre>
 *
...
public
AttributeType(BEREncoding ber, boolean check_tag)
  ...
  if (check_tag) {
    if (ber.tag_get() != 120 ||
      ...
      throw new ASN1EncodingException
        ("Zebulun: AttributeType: bad BER: tag=" + ber.tag_get() + " expected 120\n");
  }
...
ber_encode()
       throws ASN1Exception
{
  return ber_encode(BEREncoding.CONTEXT_SPECIFIC_TAG, 120);
}
